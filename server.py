...
try:
    from synapse.metrics import synapse_server_name_info
except ImportError:
    synapse_server_name_info = None
...
class HomeServer(metaclass=abc.ABCMeta):
    ...
    def __init__(
        ...
        if synapse_server_name_info is not None:
    ...
    @cache_in_self
    def get_msc4388_rendezvous_handler(self) -> Optional["MSC4388RendezvousHandler"]:
        if MSC4388RendezvousHandler is None:
            return None
