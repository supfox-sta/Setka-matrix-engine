...
CLIENT_SERVLET_FUNCTIONS: tuple[RegisterServletsFunc, ...] = (
    ...
    contact_list.register_servlets,
    setka_plus.register_servlets,
    setka_profile.register_servlets,
    setka_privacy.register_servlets,
    setka_threepid.register_servlets,
    room_wallpaper.register_servlets,
